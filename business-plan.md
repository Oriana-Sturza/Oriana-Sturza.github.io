...
The immediate focus is completing final pre-launch testing and quality assurance. Marketing and seller acquisition will commence upon launch.
...
| Risk | Mitigation |
|---|---|
| Low initial seller adoption | Targeted social media and community marketing; low fee reduces adoption barrier |
| Low buyer traffic (chicken-and-egg) | Prioritise seller onboarding first; sellers bring their own audiences |
| Sharetribe platform dependency | Monitor Sharetribe roadmap; document processes to allow future migration |
| Cash flow before break-even | Partners manage platform costs (~£300/month) until 19+ sellers are active |
| Competition from established players | Compete on pricing model, not features; serve the underserved "fee-fatigued" seller |

---

## 5. Marketing & Sales Strategy

*Marketing has not yet started — it will begin post-launch.*
